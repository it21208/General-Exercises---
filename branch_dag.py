...
from airflow.operators.bask_operator import BashOperator
...
with DAG('branch_dag', default_args=default_args, schedule_interval='@once') as dag:
    ...
    # new operator used ==> BranchPythonOperator
